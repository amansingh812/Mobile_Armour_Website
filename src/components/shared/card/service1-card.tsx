...
function Service1Card({ service1CardData }: Service1CardProps) {
  return (
    <div className="single-service-wrap min-h-[300px] md:min-h-[300px] min-h-auto flex flex-col group cursor-pointer">
      ...
      <h4 className="text-base md:text-lg font-semibold mb-2 line-clamp-2 transition-colors duration-300 group-hover:text-[#FF5600]">
        {service1CardData.title}
      </h4>
      <p className="text-gray-600 flex-grow line-clamp-3 hidden md:block">
