  ...
  return (
    <div>
      <div className="service-details-wrap">
        ...
        <h5>Mobile & Wearable Servicing</h5>
        <p>
...
We provide convenient in-store servicing by appointment. Visit our store for screen replacement, battery change, and device checkups.
        </p>
        <h5>Convenience & Corporate Solutions</h5>
        <p>
          A common yet frustrating issue is a faulty charging port. Whether your phone charges slowly or not at all, our team quickly identifies the issue and performs precise charging port service to get your device powered up and back in your hands. For those who care about the look and integrity of their phone, our back glass replacement restores your device’s original finish, using clean, safe methods and factory-quality materials.
        </p>
        <p>
          For businesses and organisations, our Business Device Services solutions are designed to keep your team connected with minimal disruption. We offer bulk device servicing, priority turnaround, and flexible account options tailored to your workflow. Whether your company uses iPhones, Androids, or a mix of both, we provide ongoing support and repairs that reduce downtime and extend the life of your devices. With a trusted reputation for quality and efficiency, Mobile Armour is the partner your business can rely on.
        </p>
        <div className="service-details-img">
          <Image
        ...
        <p>
          we combine technical expertise, premium parts, and customer-first service to deliver reliable, high-quality mobile and wearable device servicing across the board. Whether you’re an individual needing a quick screen fix or a business looking for dependable device maintenance, our solutions are designed to be fast, transparent, and hassle-free. With in-store and business account options available, we make it easy to keep your devices—and your life—running smoothly.
        </p>
      </div>
    </div>
  );
